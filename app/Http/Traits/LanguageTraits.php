...
trait LanguageTraits
{
    ...
    public function langIndex()
    {
        ...
        return view('dashboard.backEnd.common.setting.lang.language',compact('languages'));
    }
    ...
    public function translate_create($id)
    {
        ...
        return view('dashboard.backEnd.common.setting.lang.translate',compact('lang'));
    }
    ...
    public function translate_store(Request $request)
    {
        ...
        return back()->with('success','Translation has been saved.');
    }
