                ...
                <div class="card email-open-box m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3">
                                <div class="card">
                                    <img class="card-img-top" src="./{{asset('assets/images')}}/email/file-attached-1.jpg" alt="Generic placeholder image">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    <img class="card-img-top" src="./{{asset('assets/images')}}/email/file-attached-2.jpg" alt="Generic placeholder image">
                                    <div class="card-body text-center">
                                    <button type="button" class="btn btn-secondary-rgba">Download</button>
                                    </div>
                                </div>
