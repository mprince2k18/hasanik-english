...
@section('title') Group Update @endsection
                    ...
                    <div class="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="mb-3 col-md-6">
                                <textarea class="textarea sr-textarea" name="description" placeholder="Place some text here)">{{ $group->description }}</textarea>
                            </div>
                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                        <input type="checkbox"
                                                               ...
                                                               @endforeach
                                                               value="{{$item->permission->id}}"  name="permission_id[]" class="custom-control-input"
