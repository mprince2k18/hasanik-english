                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu p-2" role="menu">
                                        <li><a  href="{{ route('permissions.edit', $item->id) }}">Edit</a></li>
                                        <li><a href="{{ route('permissions.show', $item->id) }}">Show</a></li>
                                        <li class="divider"></li>
                                        <li><a href="#!"
                                               onclick="confirm_modal('{{ route('permissions.destroy', $item->id) }}')">Delete</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
